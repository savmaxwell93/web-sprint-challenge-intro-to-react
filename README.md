...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  ...
  React JS is a library built in JS to build out user interfaces using components. It helps manage large quantities of data without bogging down the DOM. It separates everything out into individual components that can be made up of their own individual pieces of state. React will then take all of those individual pieces and compile them together in a virtual DOM which will then update only the nodes on the actual DOM that have been altered. 
